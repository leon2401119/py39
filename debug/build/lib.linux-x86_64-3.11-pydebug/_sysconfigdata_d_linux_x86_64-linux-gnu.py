...
build_time_vars = {'ABIFLAGS': 'd',
 ...
 'ALIGNOF_LONG': 8,
 'ALIGNOF_SIZE_T': 8,
 'ALT_SOABI': '"cpython-311-x86_64-linux-gnu"',
 'ANDROID_API_LEVEL': 0,
 'AR': 'ar',
 'ARFLAGS': 'rcs',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -g -Og -Wall',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFINCLUDEPY': '/usr/local/include/python3.11d',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/yangck/cpython/debug/coverage.info',
 'COVERAGE_REPORT': '/home/yangck/cpython/debug/lcov-report',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-311d-x86_64-linux-gnu.so',
 'FILEMODE': 644,
 ...
 'INCLDIRSTOMAKE': '/usr/local/include /usr/local/include '
                   '/usr/local/include/python3.11d '
                   '/usr/local/include/python3.11d',
 'INCLUDEDIR': '/usr/local/include',
 'INCLUDEPY': '/usr/local/include/python3.11d',
 'INSTALL': '/usr/bin/install -c',
 'INSTALL_DATA': '/usr/bin/install -c -m 644',
 'INSTALL_PROGRAM': '/usr/bin/install -c',
 'INSTALL_SCRIPT': '/usr/bin/install -c',
 'INSTALL_SHARED': '/usr/bin/install -c -m 755',
 'INSTSONAME': 'libpython3.11d.a',
 'IO_H': 'Modules/_io/_iomodule.h',
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11d.a',
 'LDLIBRARYDIR': '',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -g -Og -Wall -std=c99 -Wextra '
 ...
 'LIBMPDEC_CFLAGS': '-Wsign-compare -g -Og -Wall -std=c99 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I../Include/internal -IObjects '
                    '-IInclude -IPython -I. -I../Include -fPIC '
                    '-I../Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    '-DHAVE_UINT128_T=1',
 'LIBMPDEC_HEADERS': '\\',
 'LIBMPDEC_OBJS': '\\',
 'LIBOBJDIR': 'Python/',
 ...
 'LIBPL': '/usr/local/lib/python3.11/config-3.11d-x86_64-linux-gnu',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.11d.a',
 'LIBRARY_DEPS': 'libpython3.11d.a',
 'LIBRARY_OBJS': '\\',
 ...
 'LINK_PYTHON_DEPS': 'libpython3.11d.a',
 'LINK_PYTHON_OBJS': '\\',
 'LIPO_32BIT_FLAGS': '',
 'LIPO_INTEL64_FLAGS': '',
 'LLVM_PROF_ERR': 'no',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -g -Og -Wall -std=c99 -Wextra '
 ...
 'PY_CFLAGS': '-Wsign-compare -g -Og -Wall',
 'PY_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-parameter '
                     '-Wno-missing-field-initializers '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden  -I../Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-Wsign-compare -g -Og -Wall -std=c99 -Wextra '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -g -Og -Wall -std=c99 -Wextra '
                        '-Wno-unused-parameter -Wno-missing-field-initializers '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I../Include/internal -IObjects '
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-311d-x86_64-linux-gnu',
 ...
 'abs_builddir': '/home/yangck/cpython/debug',
 'abs_srcdir': '/home/yangck/cpython/debug/..',
